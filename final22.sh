...
sms_bomb () {
	clear
	echo -e "\e[1;31;42m NecrO Productions  \e[0m"
 echo -e "\e[1;34m Presents \e[0m"
 echo -e "\e[1;32m NecroXT Bomber \e[0m"
 echo
 echo -e "\e[1;33m ! ! ! WARNING ! ! !        \e[0m"
 echo
 echo -e "\e[1;91;42m   ! ! ! READ THIS CAREFULLY ! ! ! \e[0m"
 echo
 echo -e "\e[1;91m This Script is Only For Educational Purposes or To Prank.\e[0m"
echo -e "\e[1;91m Do not Use This To Harm Others. \e[0m"
echo -e "\e[1;91m I Am Not Responsible For The Misuse Of The Script. \e[0m"
echo -e "\e[1;92m Make Sure To Update it If It Does not Work.\e[0m"
echo  " "
echo -e "\e[4;31m All ready to begin !!!\e[0m"
echo -e "\e[1;34m Having Queries ?\e[0m"
echo -e "\e[1;33m   Mail: NecroXTbomber@gmail.com \e[0m"
echo -e "\e[1;33m Whatsapp: https://bit.do/TheNecroGuy \e[0m"
echo -e "\e[1;34m enter to continue\e[0m"

 echo -e "\e[1;31m Press Enter To Install the requirements\e[0m"
 read a1
 ...
 echo
 echo -e "\e[1;31;42m PRESS ENTER TO CONTINUE..... \e[0m"
 read upd
 clear
 echo -e "\e[1;32m"
 figlet The Necro Guy
 echo -e "\e[1;33m Bombing Tool \e[1;31m"
 toilet -f mono12 -F border NecroXT
 echo -e "\e[4;32m This Bomber Was Created By NecrO \e[0m"
 echo -e "\e[1;32m Having queries ? \e[0m"
 echo -e "\e[1;33m Mail: necroXTbomber@gmail.com \e[0m"
 echo -e "\e[1;33m whatsapp:http://bit.do/TheNecroGuy \e[0m"
 echo
 echo -e "\e[1;35m ! ! ! USE IT ON YOUR OWN RISCK ! ! ! \e[0m"
	echo -e $RED
...
echo -e $GREEN && figlet -f slant N3CR0-XT && echo -e "$BLUE SMS + CALL Boomber " && echo -e "$RED Coded by:- N3Cr0 $WHITE"
echo ''
echo -e "\e[1;31;42m NOTE:- For indian numbers only. Call bombing and protect list will be available in the next update \e[0m"
echo ''
